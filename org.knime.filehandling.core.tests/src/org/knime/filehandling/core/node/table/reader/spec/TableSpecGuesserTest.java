...
public class TableSpecGuesserTest {
    ...
    /**
     * Tests the {@link TableSpecGuesser#guessSpec(Object, Read, TableReadConfig, ExecutionMonitor)} method if no headers are
    ...
    private void testGuessSpec(final String[][] table, final TableReadConfig<?> config,
        ...
        TypedReaderTableSpec<String> actual = m_testInstance.guessSpec("foo", read, config, m_monitor);
