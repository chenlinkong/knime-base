...
public class VersionedTableSpecConfigSerializerTest {
    ...
    public void testLoad42() throws InvalidSettingsException {
        ...
        m_testInstance.setColumnFilterMode(ColumnFilterMode.INTERSECTION);
        m_testInstance.setSkipEmptyColumns(true);
        m_testInstance.load(settings);
        verify(m_v42Serializer).setColumnFilterMode(ColumnFilterMode.INTERSECTION);
        verify(m_v42Serializer).setSkipEmptyColumns(true);
        verify(m_v42Serializer).load(settings);
    }
    ...
    public void testLoad44() throws InvalidSettingsException {
        ...
        m_testInstance.load(settings);
        verify(m_v44Serializer).setColumnFilterMode(null);
        verify(m_v44Serializer).setSkipEmptyColumns(false);
