 ...
 */
final class V42TableSpecConfigSerializer<T> extends AbstractTableSpecConfigSerializer<T> {
    ...
    V42TableSpecConfigSerializer(final ProducerRegistry<T, ?> producerRegistry, final T mostGenericType) {
        m_prodPathLoader = new DefaultProductionPathLoader(producerRegistry);
    ...
    public TableSpecConfig<T> load(final NodeSettingsRO settings) throws InvalidSettingsException {
        ...
        final ImmutableTableTransformation<T> tableTransformation = loadTableTransformation(loader);
    ...
    private ImmutableTableTransformation<T> loadTableTransformation(final Pre44Loader loader) {
        ...
        final ColumnFilterMode colFilterMode = getAndResetColumnFilterMode();
        // not stored in 4.2 therefore defaults are used
        ...
        CheckUtils.checkState(colFilterMode != null,
            "No ColumnFilterMode set. In KNIME AP 4.2 this setting was stored outside of the TableSpecConfig");
        return new ImmutableTableTransformation<>(columnTransformations, rawSpec, colFilterMode, newColPosition,
