 ...
 */
final class VersionedTableSpecConfigSerializer<T> extends AbstractTableSpecConfigSerializer<T> {
    ...
    public void save(final TableSpecConfig<T> config, final NodeSettingsWO settings) {
        ...
        getSerializer(m_currentVersion).save(config, settings);
    }
    ...
    private TableSpecConfigSerializer<T> getSerializer(final TableSpecConfigSerializerVersion version) {
        ...
        CheckUtils.checkState(serializer != null,
    ...
    public TableSpecConfig<T> load(final NodeSettingsRO settings) throws InvalidSettingsException {
        ...
        final TableSpecConfigSerializer<T> serializer = getSerializer(version);
        serializer.setColumnFilterMode(getAndResetColumnFilterMode());
        serializer.setSkipEmptyColumns(isSkipEmptyColumns());
