 ...
 */
final class V44TableSpecConfigSerializer<T> extends AbstractTableSpecConfigSerializer<T> {
    ...
    V44TableSpecConfigSerializer(final ProductionPathSerializer productionPathSerializer, final ConfigIDLoader configIDLoader,
        final NodeSettingsSerializer<T> typeSerializer) {
    ...
    public TableSpecConfig<T> load(final NodeSettingsRO settings) throws InvalidSettingsException {
        m_tableTransformationSerializer.setSkipEmptyColumns(isSkipEmptyColumns());
