...
/**
 * Default implementation of a {@link ProductionPathSerializer} that uses {@link SecureJavaToDataCellConverterRegistry}
 ...
 * KNIME. In order to remedy this, we use {@link SecureJavaToDataCellConverterRegistry}, which holds a list of
...
public final class DefaultProductionPathSerializer implements ProductionPathSerializer {
    ...
    private static JavaToDataCellConverterFactory<?> loadConverterFactory(final ConfigBaseRO config, final String key)
        ...
        final List<JavaToDataCellConverterFactory<?>> factories =
            SecureJavaToDataCellConverterRegistry.INSTANCE.getConverterFactoriesByIdentifier(id);
