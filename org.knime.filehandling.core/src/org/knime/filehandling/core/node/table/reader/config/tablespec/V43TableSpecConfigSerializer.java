 ...
 */
final class V43TableSpecConfigSerializer<T> extends AbstractTableSpecConfigSerializer<T> {
    ...
    V43TableSpecConfigSerializer(final ProductionPathSerializer productionPathLoader) {
    ...
    public TableSpecConfig<T> load(final NodeSettingsRO settings) throws InvalidSettingsException {
        final Pre44Loader loader = new Pre44Loader(settings, m_productionPathLoader);
    ...
    private static ColumnFilterMode loadColumnFilterMode(final NodeSettingsRO settings) throws InvalidSettingsException {
