 ...
 * @since 4.4
 */
public class ComplexFileReaderNodeModel extends NodeModel {
    /**
     ...
     */
    public ComplexFileReaderNodeModel(final PortsConfiguration portsConfig) {
        super(portsConfig.getInputPorts(), portsConfig.getOutputPorts()); // we need no inputs and one output, please.
        m_frSettings = null;
    }
